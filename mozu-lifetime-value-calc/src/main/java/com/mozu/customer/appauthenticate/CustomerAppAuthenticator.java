package com.mozu.customer.appauthenticate;
...
public class CustomerAppAuthenticator {
    private static final Logger logger = LoggerFactory.getLogger(CustomerAppAuthenticator.class);
    private String applicationId = null;
    private String sharedSecret = null;
    private String baseAppAuthUrl = null;
    
    public CustomerAppAuthenticator (String applicationId, String sharedSecret) {
